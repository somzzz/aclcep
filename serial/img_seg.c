...
/*		printf("print binary before normalize\n");
		printf("----------------------------------------------------------------------------------------------------");
		for (i  = 0; i < binary.ydim; i++)
		{
			for (j = 0; j < binary.xdim; j++)
...
*///		printf("------------------------------------------------------------------------------------------------------");
	...
	printf("print binary before color the matrix...\n");
	//binary.highestvalue = WHITE;
	strcpy(binary.name, "intermidiate_binary.pgm");
	OutputPgm(&binary);
